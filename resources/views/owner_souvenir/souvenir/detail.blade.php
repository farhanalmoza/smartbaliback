	...
	<script>
		...
		const getDetail = {
			...
			set successData(response) {
				// for preview detail
				$('#thumbnail').attr('src', PICT + '/thumbnail/' + response.souvenir.thumbnail)
				$('#title').text(response.souvenir.title)
				$('#address').text(response.souvenir.address)
				$('#desc').append(response.souvenir.desc)
				// gallery
