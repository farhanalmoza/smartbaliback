...
<body data-background-color="bg3">
	<div class="wrapper">
		<div class="main-header">
			...
			<!-- Navbar Header -->
			@include('owner_worship.components.topbar')
			<!-- End Navbar -->
		</div>

		<!-- Sidebar -->
		@include('owner_worship.components.sidebar')
		<!-- End Sidebar -->
	...
	<script>
		...
		const getPict = {
			...
			set successData(response) {
				...
				// template
				$('#name-sidebar').text(response.name).append('<span class="user-level">Pengelola Tempat Ibadah</span>')
