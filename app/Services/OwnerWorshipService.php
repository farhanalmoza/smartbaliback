...
class OwnerWorshipService
{
    public function getProfile($email)
    {
        $profile_id = OwnerWorship::where('email', $email)->first()->id;
        $profile = OwnerWorship::find($profile_id);
    ...
    {
        $result = OwnerWorship::where('email', $email);
    ...
    public function updateFoto($file, $email)
    {
        ...
        $profile = OwnerWorship::where('email', $email);
        if($profile) {
