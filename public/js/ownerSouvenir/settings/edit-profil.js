...
const getDetail = {
    set loadData(data) {
        const url = URL_DATA + "/pengaturan/owner-souvenir/" + data
            ...
            setTimeout(() => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        const url = URL_DATA + "/pengaturan/update/owner-souvenir/ganti-foto/" + email
...
function updateProfile() {
    ...
    $('#updateProfile').validate({
        ...
        submitHandler: function(form, e) {
            const url = URL_DATA + "/pengaturan/update/owner-souvenir/edit-profile/" + email
...
function gantiPass() {
    $('#gantiPass').validate({
        ...
        submitHandler: function(form, e) {
            const url = URL_DATA + "/pengaturan/update/owner-souvenir/ganti-password"
            const data = {
