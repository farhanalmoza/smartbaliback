...
const getDetail = {
    set loadData(data) {
        const url = URL_DATA + "/pengaturan/owner-worship/" + data
            ...
            setTimeout(() => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        const url = URL_DATA + "/pengaturan/update/owner-worship/ganti-foto/" + email
...
function updateProfile() {
    ...
    $('#updateProfile').validate({
        ...
        submitHandler: function(form, e) {
            const url = URL_DATA + "/pengaturan/update/owner-worship/edit-profile/" + email
...
function gantiPass() {
    $('#gantiPass').validate({
        ...
        submitHandler: function(form, e) {
            const url = URL_DATA + "/pengaturan/update/owner-worship/ganti-password"
            const data = {
