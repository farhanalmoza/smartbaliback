            ...
            setTimeout(() => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        const url = URL_DATA + "/pengaturan/update/owner-car/ganti-foto/" + email
...
function updateProfile() {
    ...
    $('#updateProfile').validate({
        ...
        submitHandler: function(form, e) {
            const url = URL_DATA + "/pengaturan/update/owner-car/edit-profile/" + email
...
function gantiPass() {
    $('#gantiPass').validate({
        ...
        submitHandler: function(form, e) {
            const url = URL_DATA + "/pengaturan/update/owner-car/ganti-password"
            const data = {
